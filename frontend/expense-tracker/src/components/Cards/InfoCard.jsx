...
const InfoCard = ({ icon, label, value, color }) => {
  return (
    <div className="flex items-center gap-3 md:gap-6 bg-white p-3 md:p-6 rounded-2xl shadow-md shadow-gray-100 border border-gray-200/50">
      <div
      ...
      <div>
        <h6 className="text-sm text-gray-500 mb-0.5 md:mb-1">{label}</h6>
